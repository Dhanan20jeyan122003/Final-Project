...
interface FormData {
    ...
    ca: string;
    thal: string;
    patientName: string; // Add this line for patient name
}
...
interface ResultData {
    ...
    patientName?: string; // Add this line for PDF export
    patientAge?: string; // Add this line for PDF export
}
...
export default function Heart() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        setFormData((prev) => {
            // Make sure prev isn't undefined/null
            const currentData = prev || initialFormData;
    ...
    const resetForm = () => {
        // Use the initialFormData object directly
        ...
        // Use the initialFileData and initialPreviews directly
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Store the patient name for later use in PDF
        const patientNameForPdf = formData.patientName || "Anonymous Patient";
        const ageForPdf = formData.age;
        ...
        try {
            ...
            // Add the patient name to the result for the PDF export
            result.patientName = patientNameForPdf;
            result.patientAge = ageForPdf;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-100 to-red-100 py-8 px-4 space-y-6">
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-lg w-full max-w-5xl mx-auto">
                ...
                <div className="mb-6">
                    <h3 className="text-lg font-semibold text-red-500 mb-4">Patient Information</h3>
                ...
                {resultData && (
                    <>
                        <div id="results-container" className="bg-white border border-red-300 p-6 rounded-xl mt-6 shadow-lg">
                            ...
                            {/* Add the updated HealthRecommendations component */}
                        ...
                        {/* Add the PDF Export button after the results */}
                        <PdfExport 
    ...
    return (
        <div className="flex flex-col">
            ...
            <input
                ...
                type={type}
                name={name}
                value={inputValue} // Use the sanitized value
                step={step}
                onChange={onChange}
                disabled={loading}
    ...
    return (
        <div className="flex flex-col">
            ...
            <select
                id={name}
                name={name}
                value={selectValue} // Use the sanitized value
                onChange={onChange}
                disabled={loading}
                className={`border border-red-300 p-2 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-red-400 ${
                    loading ? 'bg-gray-100 cursor-not-allowed' : ''
    ...
    return (
        <div className="flex flex-col">
            ...
            {preview && previewType === "video" && (
                <video controls className="mt-2 max-h-40 rounded border bg-gray-50">
